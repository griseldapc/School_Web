    ...
    return (
        <>
            <main>
                <Header />
                <div className="">
                    <div className="flex pt-10 mt-16 items-center justify-center flex-col">
                    <div className=" rounded-full p-[30px]">
                        <img src="./asset/berita.png" alt="" className="md:w-[710px] lg:w-[1150px]" />
                    </div>
                </div>
                <div className="text-justify px-[30px] md:px-[30px] lg:mt-10 lg:mx-6 md:mb-16 justify-center items-center mx-auto">
                    <h1 className="text-md md:text-xl text-[#619AEF] lg:text-[24px] max-w-[1150px] mx-auto">12 Desember 2020</h1>

                    <h1 className=" text-xl font-bold lg:text-left text-[#1C2661] md:text-3xl lg:text-[56px] lg:pt-5 lg:font-bold lg:leading-tight max-w-[1150px] mx-auto">
                        Gotong Royong di Sekolah, Bantu Anak Segera Kembali ke Sekolah
                    </h1>

                    <h1 className="text-md mt-3 md:text-xl lg:text-[20px] max-w-[1150px] mx-auto">Penulis : Shinta A.P</h1>

                    <p className="text-md max-w-[1150px] pt-5 md:text-xl lg:mt-5 lg:text-[20px] mx-auto">
