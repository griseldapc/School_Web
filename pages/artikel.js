...
export default function Artikel() {
  ...
  <div className="flex flex-col lg:flex-row md:flex-row mb-16 border-[#54BAEB] border-2 rounded-2xl w-[270px] md:w-[720px] lg:w-[1120px] pb-10 items-center justify-center mx-auto text-center p-3 md:h-[300px] lg:h-[450px]">
    ...
    <div className="w-[200px] md:w-[300px] h-[350px] lg:w-[600px] lg:h-[410px] flex-col text-justify pt-4 lg:pb-10  md:px-3 md:mt-16 lg:pr-8">
      ...
      <h1 className="text-xs md:text-xs lg:text-lg">
