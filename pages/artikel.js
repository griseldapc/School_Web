...
export default function Artikel(){
    ...
    <main className="font-abc">
        ...
        <div class="pt-8 text-center text-gray-800">
                    <h1 class="font-bold leadi text-[40px] pr-2 text-center items-center justify-center text-[#16215D]">Artikel</h1>
                </div>
    ...
    <div class="container flex flex-col lg:flex-row mb-16 border-[#54BAEB] border-2 ml-20 rounded-2xl w-[1110px]">
            <div class="w-[500px] h-[382px] pt-[42px] flex-col justify-end items-center inline-flex pl-12">
              <img class=" h-[400px]" src="./asset/kelas.png" />
            </div>
    <div class="w-[550px] h-[432px] flex-col items-center justify-center pb-10 text-justify ml-4 pt-10">
    <a rel="" class="text-sm text-[#3362CC] font-semibold pt-5 mt-10">12 Desember</a>
              <div class="container flex flex-col justify-center mx-auto">
                <h1 class="font-bold leadi text-[30px] pb-2">
                Gotong Royong di Sekolah, Bantu Anak Segera Kembali ke Sekolah
                </h1>
              </div>
              <h1 class="text-lg sm:mb-2">Jika anak kita ditanya apa mimpinya pasti jawabnya saya ingin kembali belajar di sekolah. Saya ingin bertemu dengan teman-teman sekelas saya. begitupun sebagian besar orang tua, mimpi mereka adalah melihat anaknya kembali ke aktivitas sekolah secara langsung. Orang tua selama ini banyak yang mengaku lelah karena anak-anaknya selama pandemi lebih banyak menghabiskan waktu di. . . 
              </h1>
...
{/* Artikel */}
    ...
    <div class="flex flex-col h-[485px] w-[350px] p-6 border-2 rounded-xl border-[#54BAEB]">
      ...
      <div class=" rounded-b-2xl pt-5 pb-9 pl-3 text-justify  ">
        ...
        <ul class="text-sm text-[#3362CC] font-semibold mt-2">Baca selengkapnya</ul>
    </div>
    </div>
  ...
  <div class="inline-flex gap-[30px] lg:px-20 mt-8">
    ...
    <div class="flex flex-col h-[485px] w-[350px] p-6 border-2 rounded-xl border-[#54BAEB]">
      ...
      <div class=" rounded-b-2xl pt-5 pb-9 pl-3 ">
        ...
        <ul class="text-sm py-2 text-[#3362CC] font-semibold mt-1">Baca selengkapnya</ul>
    </div>
    </div>
  ...
  <div class="inline-flex gap-[30px] lg:px-20 mt-8">
    <div class="flex flex-col h-[485px] w-[350px] p-6 border-2 rounded-xl border-[#54BAEB]">
      ...
      <div class=" rounded-b-2xl pt-5 pb-9 pl-3 text-justify  ">
        ...
        <ul class="text-sm py-2 text-[#3362CC] font-semibold mt-2">Baca selengkapnya</ul>
    </div>
    </div>
