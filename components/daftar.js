    ...
    return (
        <main className="flex justify-center">
          ...
          <div className="pt-[40px] mx-5 md:mx-10">
            ...
            <p className="text-base text-white mt-2 lg:text-xl">Jangan sampai melewatkan kesempatan untuk mendaftar, kami senantiasa menunggu kehadiran anak anda untuk segera belajar bersama kami.
            </p>
            <div className="py-5 lg:justify-start">
